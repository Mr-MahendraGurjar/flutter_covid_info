...
class _HomepageState extends State<Homepage> {
  ...
  fetchWorldWidedata()async {
    http.Response response = await http.get(
        "https://disease.sh/v2/all?yesterday=true&allowNull=true");
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(onRefresh: fetchData,
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
                    ...
                    GestureDetector(onTap: (){
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          child: Text("Regional").text.size(16).white.bold.make()),
                    ),
                  ],
                ),
              ),
             ...
             worldData == null ? CircularProgressIndicator(): PieChart(dataMap: {
              ...
              Info(),
              SizedBox(height: 30,),
              Center(child: "WE ARE TOGETHER WITH FIGHT".text.blue400.bold.size(13).make()),
              SizedBox(height: 10,)
